...
export function useMarsCreditManagerVaultBindingsQuery<
  TData = ArrayOfVaultBinding,
>({ client, args, options }: MarsCreditManagerVaultBindingsQuery<TData>) {
...
export function useMarsCreditManagerVaultPositionValueQuery<
  TData = VaultPositionValue,
>({ client, args, options }: MarsCreditManagerVaultPositionValueQuery<TData>) {
  return useQuery<VaultPositionValue, Error, TData>(
    marsCreditManagerQueryKeys.vaultPositionValue(
...
>({
  ...
  return useQuery<ArrayOfCoin, Error, TData>(
    marsCreditManagerQueryKeys.estimateWithdrawLiquidity(
      client?.contractAddress,
      args
    ),
    () =>
...
>({
  ...
  return useQuery<Uint128, Error, TData>(
    marsCreditManagerQueryKeys.estimateProvideLiquidity(
      client?.contractAddress,
      args
    ),
    () =>
...
export function useMarsCreditManagerAllTotalDebtSharesQuery<
  TData = ArrayOfDebtShares,
>({ client, args, options }: MarsCreditManagerAllTotalDebtSharesQuery<TData>) {
  return useQuery<ArrayOfDebtShares, Error, TData>(
    marsCreditManagerQueryKeys.allTotalDebtShares(
      client?.contractAddress,
      args
    ),
    () =>
...
export function useMarsCreditManagerAllDebtSharesQuery<
  TData = ArrayOfSharesResponseItem,
>({ client, args, options }: MarsCreditManagerAllDebtSharesQuery<TData>) {
...
>({ client, args, options }: MarsCreditManagerAllCoinBalancesQuery<TData>) {
...
>({
  ...
  args,
  options,
}: MarsCreditManagerAllVaultUtilizationsQuery<TData>) {
  return useQuery<PaginationResponseForVaultUtilizationResponse, Error, TData>(
    marsCreditManagerQueryKeys.allVaultUtilizations(
      client?.contractAddress,
      args
    ),
    () =>
...
export function useMarsCreditManagerVaultUtilizationQuery<
  TData = VaultUtilizationResponse,
>({ client, args, options }: MarsCreditManagerVaultUtilizationQuery<TData>) {
...
export function useMarsCreditManagerCallbackMutation(
  ...
  return useMutation<ExecuteResult, Error, MarsCreditManagerCallbackMutation>(
    ({ client, msg, args: { fee, memo, funds } = {} }) =>
      client.callback(msg, fee, memo, funds),
    options
  );
}
...
export function useMarsCreditManagerUpdateNftConfigMutation(
  options?: Omit<
    UseMutationOptions<
      ExecuteResult,
      Error,
      MarsCreditManagerUpdateNftConfigMutation
    >,
    'mutationFn'
  >
) {
...
export function useMarsCreditManagerUpdateOwnerMutation(
  options?: Omit<
    UseMutationOptions<
      ExecuteResult,
      Error,
      MarsCreditManagerUpdateOwnerMutation
    >,
    'mutationFn'
  >
) {
  ...
  >(
    ({ client, msg, args: { fee, memo, funds } = {} }) =>
      client.updateOwner(msg, fee, memo, funds),
    options
  );
}
...
export function useMarsCreditManagerUpdateConfigMutation(
  options?: Omit<
    UseMutationOptions<
      ExecuteResult,
      Error,
      MarsCreditManagerUpdateConfigMutation
    >,
    'mutationFn'
  >
) {
...
export function useMarsCreditManagerRepayFromWalletMutation(
  options?: Omit<
    UseMutationOptions<
      ExecuteResult,
      Error,
      MarsCreditManagerRepayFromWalletMutation
    >,
    'mutationFn'
  >
) {
...
export function useMarsCreditManagerUpdateCreditAccountMutation(
  options?: Omit<
    UseMutationOptions<
      ExecuteResult,
      Error,
      MarsCreditManagerUpdateCreditAccountMutation
    >,
    'mutationFn'
  >
) {
...
export function useMarsCreditManagerCreateCreditAccountV2Mutation(
  options?: Omit<
    UseMutationOptions<
      ExecuteResult,
      Error,
      MarsCreditManagerCreateCreditAccountV2Mutation
    >,
    'mutationFn'
  >
) {
...
export function useMarsCreditManagerCreateCreditAccountMutation(
  options?: Omit<
    UseMutationOptions<
      ExecuteResult,
      Error,
      MarsCreditManagerCreateCreditAccountMutation
    >,
    'mutationFn'
  >
) {
